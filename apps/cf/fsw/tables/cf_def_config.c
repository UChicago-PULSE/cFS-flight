...
CF_ConfigTable_t CF_config_table = {
    ...
    {      /* channel configuration for CF_NUM_CHANNELS */
     {
         /* channel 0 */
         2,      /* max number of outgoing messages per wakeup (reduced for flow control through CSP) */
     ...
     {        /* channel 1 */
      ...
      1,  /* dequeue enable flag (1 = enabled) */
      .move_dir = ""}},
    180,        /* outgoing_file_chunk_size (sized to fit within BUS_COMMS_MAX_SEND_LEN=220 with CFDP header overhead) */
